    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">StockPredictAI</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Advanced stock market predictions powered by machine learning and XAI.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-blue-500" aria-label="GitHub">
              ...
              <a href="#" className="text-gray-400 hover:text-blue-500" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              <li><Link to="/learn" className="hover:text-blue-500">Learning Center</Link></li>
              <li><Link to="/faq" className="hover:text-blue-500">FAQ</Link></li>
              <li><Link to="/blog" className="hover:text-blue-500">Blog</Link></li>
              <li><Link to="/api" className="hover:text-blue-500">API Documentation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <a href="mailto:contact@stockpredictai.com" className="text-blue-600 hover:text-blue-500">contact@stockpredictai.com</a>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} StockPredictAI. All rights reserved.
          </p>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-4 md:mt-0">
            Last updated: 2025-03-12 05:43:55 UTC
          </p>
        </div>
      </div>
    </footer>
